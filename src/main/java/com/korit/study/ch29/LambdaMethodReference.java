...
public class LambdaMethodReference {
    ...
    //람다 생성자 참조
        ...
        //Bi: 바이너리 , 두개 / 매개변수 두개라는 뜻 (BiFunction,BiConsumer , BiPredict )
        BiFunction<String,Integer,Student> biFunction = (name,age)-> new Student(name, age);
        Student student1 = biFunction.apply("김준일",32);
        BiFunction<String,Integer,Student> biFunction2 = Student::new;
        Student student2 = biFunction.apply("김준일",32);
        ...
        Integer num2 = strToInt.apply("100");
        ...
        strNums.stream().map(Integer::parseInt).collect(Collectors.toList()).forEach(n->atomicSumResult.set(atomicSumResult.get()+n));
